...
int main ( int argc, char **argv )
{
    ...
    tests.push_back ( testMethod ( "MatrixCleverTransposeOpenMP", 2, runMatrixCleverBlockTransposeOpenMP, "Same as cleverTranspose, but with OpenMP" ) );
    tests.push_back ( testMethod ( "MatrixCleverBlockTransposeOpenMP", 2, runMatrixCleverBlockTransposeOpenMP, "Same as cleverTranspose, but with OpenMP" ) );
...
void runMatrixCleverBlockTransposeOpenMP ( tester *test, char **args )
{
    ...
    adhereTo<double> *Arows[n_blocks * n_blocks];
    adhereTo<double> *Brows[n_blocks * n_blocks];
